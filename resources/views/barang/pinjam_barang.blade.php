...
@section('content')
                    <div class="card-body">
                        <form action="/pinjam/{{ $barang->id }}" method="post">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                id="inputPassword4" value="{{ $barang->stok_barang }}" readonly>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputPassword5">Jumlah Barang</label>
                                <input name="jml_pinjam" type="number" class="form-control" 
                                id="inputPassword5" placeholder="Masukan Jumlah Barang" min="1">
                            </div>
                            @error('jml_pinjam')
